...
public class DBHelper {
    ...
    public PagedResponse<LinkedHashMap<String, Object>> queryPage(DataSourceItem dsItem, String sql, String sumSql, int pageIndex, int pageSize) throws SQLException, ClassNotFoundException {
        PagedResponse<LinkedHashMap<String, Object>> result = new PagedResponse<>();
        result.setPageSize(pageSize);
        result.setCurrentPage(pageIndex);
        Connection connection = dsItem.getConn();
        ResultSet rs = null;
        Statement pst = null;
        try {
