...
import com.sqber.weibotest.result.BaseResponse;
import com.sqber.weibotest.result.FileUploadResult;
...
public class FileController {
    ...
    public BaseResponse getlist(FileQuery fileQuery) throws Exception {
        PagedResponse<MyFile> pagedResponse = fileService.get(fileQuery);
        return BaseResponse.ok(pagedResponse);
    }
...
//        }
        ...
        try {
            ...
            String newFileName = filePath.replace(fileUploadConfig.getSavePath(), "");
            fileService.add(newFileName, filePath);
